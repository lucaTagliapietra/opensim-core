...
{
  try {
    OpenSim::Storage result1("../simplePendulum_energy_energyReporter_probes.sto"), standard1("../std_simplePendulum_energy_energyReporter_probes.sto");
    ...
    OpenSim::Storage result2("../nFourBarMechanism_energy_energyReporter_probes.sto"), standard2("../std_nFourBarMechanism_energy_energyReporter_probes.sto");
    ...
    OpenSim::Storage result3("../andrewsMechanism_energy_energyReporter_probes.sto"), standard3("../std_andrewsMechanism_energy_energyReporter_probes.sto");
    ...
    OpenSim::Storage result4("../bricardsMechanism_energy_energyReporter_probes.sto"), standard4("../std_bricardsMechanism_energy_energyReporter_probes.sto");
    ...
    OpenSim::Storage result5("../flyballGovernor_kinematics_pointKinematicsReporter_NONAME_pos.sto"), standard5("../flyballGovernor_kinematics_pointKinematicsReporter_NONAME_pos.sto");
